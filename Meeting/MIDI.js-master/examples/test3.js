...
function makeEventArray1 () {
  var eventArray = [];
  eventArray.push(new Event(0, 1, 67, 'D', 0.8, 0.5) );
...
function makeEventArray1a1 () {
  var eventArray = [];
  eventArray.push(new Event(0, 1, 67, 'D', 0.8, 0.5) );
  eventArray.push(new Event(1, 1, 69, 'S') );
  eventArray.push(new Event(2, 1, 71, 'S') );
  eventArray.push(new Event(3, 1, 72, 'S') );
  period = 4;
  return eventArray;
}

function makeEventArray1a2 () {
  var eventArray = [];
  eventArray.push(new Event(0, 1, 67, 'DS', 0.8, 0.5) );
  eventArray.push(new Event(1, 1, 69, 'US') );
  eventArray.push(new Event(2, 1, 71, 'DS') );
  eventArray.push(new Event(3, 1, 72, 'US') );
  period = 4;
  return eventArray;
}

function makeEventArray1a3 () {
  var eventArray = [];
  eventArray.push(new Event(0, 1, 67, 'DP', 0.8, 0.5) );
  eventArray.push(new Event(1, 1, 69, 'SP') );
  eventArray.push(new Event(2, 1, 71, 'SP') );
  eventArray.push(new Event(3, 1, 72, 'SP') );
  period = 4;
  return eventArray;
}
